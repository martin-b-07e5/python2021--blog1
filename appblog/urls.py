# ~/django/myProjects/blog1/appblog/urls.py
...
urlpatterns = [
    ...
    # --------------------
    path(
        "filter_by_category_two/", filter_by_category_two, name="filter_by_category_two"
    ),
    # --------------------
    path("filter_by_category/", filter_by_category, name="filter_by_category"),
    path(
        "filter_by_category_reverse/",
        filter_by_category_reverse,
        name="filter_by_category_reverse",
    ),
    # --------------------
    path("filter_by_title/", filter_by_title, name="filter_by_title"),
    path(
        "filter_by_title_reverse/",
        filter_by_title_reverse,
        name="filter_by_title_reverse",
    ),
    # --------------------
    path("filter_by_created/", filter_by_created, name="filter_by_created"),
    path(
        "filter_by_created_reverse/",
        filter_by_created_reverse,
        name="filter_by_created_reverse",
    ),
    path("filter_by_publish/", filter_by_publish, name="filter_by_publish"),
    path(
        "filter_by_publish_reverse/",
        filter_by_publish_reverse,
        name="filter_by_publish_reverse",
    ),
    path("filter_by_updated/", filter_by_updated, name="filter_by_updated"),
    path(
        "filter_by_updated_reverse/",
        filter_by_updated_reverse,
        name="filter_by_updated_reverse",
    ),
    # --------------------
    # --------------------
    # 🔥 done
    path(
        "filter_by_number_of_comments/",
        filter_by_number_of_comments,
        name="filter_by_number_of_comments",
    ),
]
